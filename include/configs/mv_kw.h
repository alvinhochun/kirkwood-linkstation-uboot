...
#if defined(CONFIG_BUFFALO_PLATFORM)
#define	CFG_PROMPT	"BUFFALO>> "	/* Monitor Command Prompt	*/
#else
...
#define CFG_FLASH_SIZE      	_512K	

#if defined(MV_SEC_64K)
// #if defined(MV_TINY_IMAGE)
  	#define CFG_MONITOR_LEN		(512 << 10) - 0x10000	/* Reserve 64 kB for Monitor */
// #else
...
#define CFG_ENV_ADDR    		(CFG_MONITOR_BASE + CFG_FLASH_SIZE - CFG_ENV_SECT_SIZE)
#undef CFG_ENV_SIZE
#define CFG_ENV_SIZE			CFG_ENV_SECT_SIZE /* environment take 1 block */	
#define CFG_ENV_OFFSET			(CFG_FLASH_SIZE - CFG_ENV_SIZE)
...
#define CFG_ENV_ADDR    			CFG_MONITOR_IMAGE_DST
		...
		defined(CONFIG_BUFFALO_PLATFORM)
