...
buffalo_mvlsxh_6281_config \
buffalo_mvwxl_6281_config \
buffalo_mvlsvl_6282_config \
buffalo_mvlswvl_6282_config \
buffalo_mvlsxlv2_6192_config \
:
	@$(MAKE) -s mv_kw RULE=$@
...
#=======================
# Buffalo Platform flag
#=======================
	@[ -z "$(findstring buffalo,$(RULE))" ] || \
		{ echo "MV_FLAGS += -DCONFIG_BUFFALO_PLATFORM" >> include/config.mk;  \
		  echo "** Buffalo Platform image ** config " ; \
		}
...
#=======================
	...
	@[ -z "$(findstring db88f6282abp_config,$(RULE))" ] || \
	...
	@[ -z "$(findstring buffalo_mvlsxh,$(RULE))" ] || \
		{ echo "MV_FLAGS += -DBF_MVLSXH" >> include/config.mk;  \
		  echo "MV_IMAGE_FLAGS = -DMV_SEC_64K" >> include/config.mk;	\
		  echo "MV_IMAGE_FLAGS += -DMV_BOOTSIZE_512K" >> include/config.mk;	\
		  echo "MV_IMAGE_FLAGS += -DMV_LARGE_PAGE" >> include/config.mk;	\
		  echo "MV_FLAGS += -DMV_BOOTROM" >> include/config.mk;	\
		  echo "MV_FLAGS += -DTCLK_AUTO_DETECT" >> include/config.mk; \
		  echo "MV_DDR_FREQ = 400mvlsxh" >> include/config.mk;	\
		  cp board/mv_feroceon/config_kw/u-boot-mvlsxh.lds board/mv_feroceon/config_kw/u-boot.lds;	\
		  echo "** MVLSXH ** config " ; \
		}
	@[ -z "$(findstring buffalo_mvwxl,$(RULE))" ] || \
		{ echo "MV_FLAGS += -DBF_MVWXL" >> include/config.mk;  \
		  echo "MV_IMAGE_FLAGS = -DMV_SEC_64K" >> include/config.mk;	\
		  echo "MV_IMAGE_FLAGS += -DMV_BOOTSIZE_512K" >> include/config.mk;	\
		  echo "MV_IMAGE_FLAGS += -DMV_LARGE_PAGE" >> include/config.mk;	\
		  echo "MV_FLAGS += -DMV_BOOTROM" >> include/config.mk;	\
		  echo "MV_FLAGS += -DMV_MMC" >> include/config.mk;	\
		  echo "MV_FLAGS += -DTCLK_AUTO_DETECT" >> include/config.mk; \
		  echo "MV_DDR_FREQ = 300wxl" >> include/config.mk;	\
		  cp board/mv_feroceon/config_kw/u-boot-mvlsxh.lds board/mv_feroceon/config_kw/u-boot.lds;	\
		  echo "** MVWXL ** config " ; \
		}
	@[ -z "$(findstring buffalo_mvlsvl,$(RULE))" ] || \
		{ echo "MV_FLAGS += -DBF_MVLSVL" >> include/config.mk;  \
		  echo "MV_IMAGE_FLAGS = -DMV_SEC_64K" >> include/config.mk;	\
		  echo "MV_IMAGE_FLAGS += -DMV_BOOTSIZE_512K" >> include/config.mk;	\
		  echo "MV_IMAGE_FLAGS += -DMV_LARGE_PAGE" >> include/config.mk;	\
		  echo "MV_FLAGS += -DMV_BOOTROM" >> include/config.mk;	\
	...
	@[ -z "$(findstring buffalo_mvlswvl,$(RULE))" ] || \
		{ echo "MV_FLAGS += -DBF_MVLSWVL" >> include/config.mk;  \
		  echo "MV_IMAGE_FLAGS = -DMV_SEC_64K" >> include/config.mk;	\
		  echo "MV_IMAGE_FLAGS += -DMV_BOOTSIZE_512K" >> include/config.mk;	\
		  echo "MV_IMAGE_FLAGS += -DMV_LARGE_PAGE" >> include/config.mk;	\
		  echo "MV_FLAGS += -DMV_BOOTROM" >> include/config.mk;	\
	...
	@[ -z "$(findstring buffalo_mvlsxlv2,$(RULE))" ] || \
		{ echo "MV_FLAGS += -DBF_MVLSXLV2" >> include/config.mk;  \
		  echo "MV_IMAGE_FLAGS = -DMV_SEC_64K" >> include/config.mk;	\
		  echo "MV_IMAGE_FLAGS += -DMV_BOOTSIZE_512K" >> include/config.mk;	\
		  echo "MV_IMAGE_FLAGS += -DMV_LARGE_PAGE" >> include/config.mk;	\
		  echo "MV_FLAGS += -DMV_BOOTROM" >> include/config.mk;	\
...
#=================
ifeq ($(DDR3),1)
	@echo "** DDR3 support image ** config " ;
